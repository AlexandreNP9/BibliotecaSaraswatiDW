                                ...
                                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="Nome do Status" style="width: 206px;">Status</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        ...
                                        <c:forEach var="cat" items="${dao.listInOrderNome()}"> 
                                            <tr>
                                                <td><a href="${pageContext.request.contextPath}/paginas/statusCadastro.jsp?id=${cat.getIdStatus()}">editar</a></td>
