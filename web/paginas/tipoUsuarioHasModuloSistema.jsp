<%-- 
    Document   : testeTipoUsuarioHasModuloSistema
...
<html lang="en">
    ...
    <head> <link rel="stylesheet" href="../dist/css/sb-admin-2.css">
        ...
        <title>Lista de tipoUsuarioHasModuloSistemas</title>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    TipoUsuarioHasModuloSistemas Cadastrados
                </div>
                <!-- /.panel-heading -->
                    ...
                    <div id="dataTables-example_wrapper" class="dataTables_wrapper form-inline dt-bootstrap no-footer">
                        <div class="row"><div class="col-sm-12">
                                <table width="100%" class="table table-striped table-bordered table-hover dataTable no-footer dtr-inline" id="dataTables-example" role="grid" aria-describedby="dataTables-example_info" style="width: 100%;">
                                    <thead>
                                        <tr role="row">
                                            <th class="sorting" tabindex="0" aria-controls="dataTables-example" rowspan="1" colspan="1" aria-label="TipoUsuario da tipoUsuarioHasModuloSistema" style="width: 147px;">TipoUsuario</th>
