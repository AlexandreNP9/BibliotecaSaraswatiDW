...
<html>
    <head> <link rel="stylesheet" href="../dist/css/sb-admin-2.css">
        ...
        <title>Cadastro de tipoObra</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cadastro de Tipos de Obra</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <form method="post" action="${pageContext.request.contextPath}/tipoObra" role="form">
                    <div class="row">
                        <div class="col-lg-6">        
                            <div class="form-group">
                                ...
                                <% } else {%>
                                <span class="form-control" disabled ><%=cat.getIdtipoObra()%></span>
                                <% }%>
                                <input class="form-control"  type="hidden" name="id" value="<%=cat.getIdtipoObra()%>"/>
                        ...
                        <div class="col-lg-6">        
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nome" value="<%=editando != null ? cat.getNometipoObra() : ""%>"/>
                            </div>
                        </div>
                    </div>
