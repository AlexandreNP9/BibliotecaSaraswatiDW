    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cadastro de Obras</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <form method="post" action="${pageContext.request.contextPath}/obra" role="form">
                    <div class="row">
                        <div class="col-lg-6">        
                        ...
                        <div class="col-lg-6">        
                            <div class="form-group">
                                ...
                                <select class="form-control" name="tipoObra">
                                    ...
                                    <option value="<%=c.getIdtipoObra()%>"><%=c.getNometipoObra()%></option>
                                    <% }%>
                                </select>
                            </div>
                        </div>                        
