    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Cadastro de Tipo de Usuários</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
                <form method="post" action="${pageContext.request.contextPath}/tipoUsuario" role="form">
                    <div class="row">
                        <div class="col-lg-6">        
                            <div class="form-group">
                                ...
                                <% } else {%>
                                <span class="form-control" disabled ><%=cat.getIdTipoUsuario()%></span>
                                <% }%>
                                <input class="form-control"  type="hidden" name="id" value="<%=cat.getIdTipoUsuario()%>"/>
                        ...
                        <div class="col-lg-6">        
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="nome" value="<%=editando != null ? cat.getNomeTipoUsuario() : ""%>"/>
                            </div>
                        </div>
                    </div>
