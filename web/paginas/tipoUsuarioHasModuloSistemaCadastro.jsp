<%-- 
    Document   : tipoUsuarioHasModuloSistemaCadastro
...
<html>
    <head> <link rel="stylesheet" href="../dist/css/sb-admin-2.css">
        ...
        <title>Cadastrar um TipoUsuarioHasModuloSistema</title>
        <!-- Bootstrap Core CSS -->
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Conceder Modulo do Sistema para Tipos de Usuário</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
