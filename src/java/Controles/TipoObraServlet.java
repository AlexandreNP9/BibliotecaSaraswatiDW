 ...
 * @author a1602896
 */
@WebServlet(name = "TipoObraServlet", urlPatterns = {"/tipoObra"})
public class TipoObraServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            if (!request.getParameter("id").equals("null")) {
                ...
                TipoObra tipoObra = daoTipoObra.listById(id).get(0);
                tipoObra.setNometipoObra(nome);//novo nome
                daoTipoObra.atualizar(tipoObra);
            } else {
            ...
            response.sendRedirect(request.getContextPath() + "/paginas/tipoObraListaScriptlet.jsp");
        }
